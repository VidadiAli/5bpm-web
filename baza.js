localStorage.setItem("midtermDate", "Aralıq imtahan I </br> 10 Okt - 25 Okt")
...
let objectofStudent = [
    student1 = {
        ...
        qrafika : { kolluk1: 0, kolluk2: 0, kolluk3: 0, davamiyyet: 0, serbestish: 0, resultofexam: 0 },
        dizayn : { kolluk1: 0, kolluk2: 0, kolluk3: 0, davamiyyet: 0, serbestish: 0, resultofexam: 0 },
...
if (password == "5vv6ksa") {
    let mehemmed = 28, adil = 26, altay = 22, aysel = 30, eli = 28, elisadir = 5, fateh = 28,
        govher = 17, gullale = 30, shelale = 31, huseyn = 28, inal = 25, konul = 18,
         murad = 27, naile = 27, necibe = 28,  oruc = 27, sebine = 26, serfi = 26, yusif = 25;
    ...
    listOfStudentsName = ["Məhəmməd", "Adil", "Altay", "Aysel", "Əli", "Əlisadir", "Fateh",
        ...
        "Murad", "Nailə", "Nəcibə",  "Oruc", "Səbinə", "Sərvi", "Yusif"];



    listOfStudentsSureN = ["Musayeva", "Rüstəmova", "Əlimərdanlı", "Rəhimə", "Quliyev", "Əzizli", "Quliyev", "Rzaquliyeva",
        "Əşrəfli", "Məmmədli"];
